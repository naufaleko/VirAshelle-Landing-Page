...
export function About() {
  return (
    <section id="about" className="relative py-32 md:py-40 bg-transparent text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-0 h-[3px] w-full bg-gradient-to-r from-brand to-brand-light origin-left rounded-full"
          />
        </motion.div>
